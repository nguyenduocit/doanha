    ...
    <div class="x_content">
          <form action="" class="form-horizontal" id="block-validate" novalidate="novalidate" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group <?php echo !empty(form_error('tenhocham')) ? 'has-error' : '' ?>">
                ...
                <div class="col-lg-7">
                    <input type="text" id="required2" name="tenhocham" class="form-control" value=" <?php set_value('tenhocham') ?>" placeholder="Tên học hàm">
             ...
             <div class="form-group <?php echo !empty(form_error('mahocham')) ? 'has-error' : '' ?>">
                ...
                <div class="col-lg-7">
                    <input type="text" id="required2" name="mahocham" class="form-control" value="<?php set_value('mahocham') ?>" placeholder="Mã hoc hàm">
