    ...
    <div class="x_content">
          <form action="" class="form-horizontal" id="block-validate" novalidate="novalidate" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group <?php echo !empty(form_error('maquydinh')) ? 'has-error' : '' ?>">
                ...
                <div class="col-lg-7">
                    <input type="text" id="required2" name="maquydinh" class="form-control" value="<?php set_value('maquydinh') ?>" placeholder="Mã quy định: ">
            ...
            <div class="form-group <?php echo !empty(form_error('sogiochuan')) ? 'has-error' : '' ?>">
                ...
                <div class="col-lg-7">
                    <input type="number" id="required2" name="sogiochuan"  class="form-control sogiochuan" value="<?php set_value('sogiochuan') ?>"  placeholder="Số giờ chuẩn">
             ...
             <div class="form-group <?php echo !empty(form_error('mucthanhtoan')) ? 'has-error' : '' ?>">
                ...
                <div class="col-lg-7">
                    <input type="number" id="required2" name="mucthanhtoan"  class="form-control  mucthanhtoan" value="<?php set_value('mucthanhtoan') ?>"  placeholder="Mức thanh toán ">
