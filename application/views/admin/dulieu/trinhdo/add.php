    ...
    <div class="x_content">
          <form action="" class="form-horizontal" id="block-validate" novalidate="novalidate" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group <?php echo !empty(form_error('tentrinhdo')) ? 'has-error' : '' ?>">
                ...
                <div class="col-lg-7">
                    <input type="text" id="required2" name="tentrinhdo" class="form-control" value=" <?php set_value('tentrinhdo') ?>" placeholder="Tên học hàm">
             ...
             <div class="form-group <?php echo !empty(form_error('matrinhdo')) ? 'has-error' : '' ?>">
                ...
                <div class="col-lg-7">
                    <input type="text" id="required2" name="matrinhdo" class="form-control" value="<?php set_value('matrinhdo') ?>" placeholder="Mã trình độ">
