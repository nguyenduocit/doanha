          ...
          <form action="" class="form-horizontal" id="block-validate" novalidate="novalidate" method="POST" enctype="multipart/form-data">
                <div class="col-lg-6">
                    ...
                    <div class="form-group <?php echo !empty(form_error('sex')) ? 'has-error' : '' ?>">
                        ...
                        <div class="col-lg-7">
                            ...
                            <input type="radio"  value="0" id="optionsRadios1" name="sex"> Nữ 
                        </div>
                    </div>
                ...
                <div class="col-lg-6">
                    ...
                    <div class="form-group <?php echo !empty(form_error('diachi')) ? 'has-error' : '' ?>">
                        ...
                        <div class="col-lg-7">
                            <input type="text" id="required2" name="diachi" class="form-control" value="<?php set_value('diachi') ?>" placeholder = " Địa chỉ" >
                    ...
                    <div class="form-group <?php echo !empty(form_error('hocham')) ? 'has-error' : '' ?>">
                        ...
                        <div class="col-lg-7">
                            ...
                            <?php foreach($list_hocham as $value )  {?>
                               <option value="<?php echo $value ->mahocham ?>"><?php echo $value ->tenhocham ?></option>
                            <?php } ?>
                            </select>
                    ...
                    <div class="form-group <?php echo !empty(form_error('chucvu')) ? 'has-error' : '' ?> ">
                        ...
                        <div class="col-lg-7">
                            ...
                            <?php foreach($list_chucvu as $value )  {?>
                               <option value="<?php echo $value ->machucvu ?>"><?php echo $value ->tenchucvu ?></option>
                            <?php } ?>
                            </select>
