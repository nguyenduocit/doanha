    ...
    <div class="x_content">
          <form method="post" action="" class="form-horizontal" id="block-validate" novalidate="novalidate"  enctype="multipart/form-data">
            ...
            <div class="form-group <?php echo !empty(form_error('mahedaotao')) ? 'has-error' : '' ?>">
                ...
                <div class="col-lg-7">
                    <input type="text" id="required2" name="mahedaotao" class="form-control" value="<?php echo $hedaotaoEdit->mahedaotao ?>" placeholder="Mã hệ đào tạo">
            ...
            <div class="form-group">
                ...
                <div class="col-lg-3">
                    <select class="form-control" name="soky">
                        <option value="0" <?php echo ($hedaotaoEdit->soky == 1 ? 'selected = "selected"' : '') ?>>1</option>
                        <option value="1" <?php echo ($hedaotaoEdit->soky == 2 ? 'selected = "selected"' : '') ?>>2</option>
                        <option value="2" <?php echo ($hedaotaoEdit->soky == 3 ? 'selected = "selected"' : '') ?>>3</option>
                        <option value="3" <?php echo ($hedaotaoEdit->soky == 4 ? 'selected = "selected"' : '') ?>>4</option>
                        <option value="4" <?php echo ($hedaotaoEdit->soky == 5 ? 'selected = "selected"' : '') ?>>5</option>
                        <option value="5" <?php echo ($hedaotaoEdit->soky == 6 ? 'selected = "selected"' : '') ?>>6</option>
                        <option value="6" <?php echo ($hedaotaoEdit->soky == 7 ? 'selected = "selected"' : '') ?>>7</option>
                        <option value="7" <?php echo ($hedaotaoEdit->soky == 8 ? 'selected = "selected"' : '') ?>>8</option>
                        <option value="7" <?php echo ($hedaotaoEdit->soky == 9 ? 'selected = "selected"' : '') ?>>9</option>
                        <option value="7" <?php echo ($hedaotaoEdit->soky == 10 ? 'selected = "selected"' : '') ?>>10</option>
                    </select>
